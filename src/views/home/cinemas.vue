...
export default {
  ...
  created() {
    ...
    axios
      .get(
        '/maoyan/ajax/cinemaList?day=2019-10-16&offset=0&limit=20&districtId=-1&lineId=-1&hallType=-1&brandId=-1&serviceId=-1&areaId=-1&stationId=-1&item=&updateShowDay=true&reqId=1571191114871&cityId=30',
        {
          params: {
            day: 2019 - 10 - 16,
            offset: 0,
